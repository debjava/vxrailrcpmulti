...
public class ToRSwitchInfoPage extends FormPage {
  private static String ID = "torswitchinfo";
  private static String TITLE = "ToR Switch Information";

  public ToRSwitchInfoPage(FormEditor editor, String id, String title) {
    super(editor, id, title);
  }

  public ToRSwitchInfoPage(FormEditor editor) {
    super(editor, ID, TITLE);
  }
  ...
  private void setFormAction(Form form) {
    ...
    Action nextAction = ActionUtil.getAction(form.getShell(), new NextActionHandlerImpl(this, "validation"));
    Action prevAction = ActionUtil.getAction(form.getShell(), new PreviousActionHandler(this, "virtualization"));
